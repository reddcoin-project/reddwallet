...
'      <td><a href="" ng-click="copy($index)">Copy</a></td>',
'    </tr>',
'  </tbody>',
'</table>',''].join("\n"));
}])
...
'    <div class="col-sm-9">',
'      <input type="text" ng-model="send.amount" ng-change="updateMetaTotal()" maxlength="15" class="form-control">',
'    </div>',
'  </div>',
'  <div class="form-group">',
...
'  <div class="form-group">',
'    <div class="col-sm-9">',
'      <div class="alert alert-actions">Amount + Fee (0.001): {{ meta.totalAmount | number:8 }}</div>',
'    </div>',
'    <div class="col-sm-3">',
